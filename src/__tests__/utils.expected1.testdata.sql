-- ckl related tables:
SELECT * FROM CKL_DEFAULTLAYOUTS cd;

SELECT * FROM CKL_LAYOUTGROUPS cl;

SELECT * FROM CKL_LAYOUTS cl;

SELECT * FROM CKL_LAYOUTTYPES cl;

SELECT * FROM CKL_MAILBOXLAYOUTS cm;

SELECT * FROM CKL_USERLAYOUTS cu;

SELECT * FROM DEVICETYPES d;
